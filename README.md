...
[![GPU](https://img.shields.io/badge/NVIDIA%20CUDA-accelerated-76B900)](crates/oxmera-cuda)
...
**Apple-Silicon Metal**, and **NVIDIA CUDA** backends, tape-based reverse-mode **autograd**,
...
| optim | `SGD`, `Adam`, and `AdamW` with per-group learning rate and weight decay (`ParamGroup`); decay-free `RMSprop` with per-group learning rate; one fused launch per parameter on Metal and CUDA |
